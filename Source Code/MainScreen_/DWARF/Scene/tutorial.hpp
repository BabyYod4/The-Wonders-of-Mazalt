...
@brief This file contains an example of an tutorial implementation
@warning PLEASE DO NOT USE THIS FILE AS A PART OF THE LIBRARY
*/
...
private:
	...
	player_data<60, 60, true, false> & oof_outside;
	game_map<60, 60> & map;
...
public:
		...
		map(map)
	{
		...
		texture_ossas.loadFromFile(TEXTURES + "Ossas_oldman.png");
